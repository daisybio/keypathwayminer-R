...
# Run kpm
local_example_2 <- kpm(graph_file = sample_network, indicator_matrices = indicator_matrices)
...
# Run kpm
local_example_3 <- kpm(graph_file = sample_network, indicator_matrices = indicator_matrices)
